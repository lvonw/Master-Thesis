...
Der \ac{VAE} hat als vortrainierte Komponente eines \ac{LDM}s zwei Aufgaben. Zum einen müssen die erzeugten latenten Repräsentationen für ein \ac{DM} sinnvoll zu verarbeiten sein. Zum anderen muss die Rekonstruktion der Daten maximal verlustfrei sein. \\
...
\begin{figure}[htbp]
    \centering
    \subfloat{%
        \includegraphics[width=0.40\textwidth]{images/results/sketch/sk_perlin_750s.png}
    }
    \subfloat{%
        \includegraphics[width=0.40\textwidth]{images/results/sketch/sk_perlin_750.png}
    }
    
    \vspace{-8pt}

    \subfloat{%
        \includegraphics[width=0.70\textwidth]{images/results/sketch/sk_perlin_750r.png}
    }

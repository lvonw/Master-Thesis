...
Wertebereich so klein wie möglich ist.  blablabla irgendwelche diagramme oder so kein plan ... mit etwa 18,5\% aller Höhenwerte

\begin{figure}[htbp]
    \centering
    \subfloat{%
        \includegraphics[width=0.85\textwidth]{images/Data/graphs/pixel values cum perc.png}
    }
...
\begin{figure}[htbp]
    \centering
    \subfloat{%
        \includegraphics[width=0.85\textwidth]{images/Data/graphs/pixel values cum perc 1 9000.png}
    }

...
\begin{figure}[htbp]
    \centering
    \subfloat{%
        \includegraphics[width=0.20\textwidth]{images/Data/source1.png}
    }
    \subfloat{%
        \includegraphics[width=0.20\textwidth]{images/Data/source2.png}
    }
    \subfloat{%
        \includegraphics[width=0.20\textwidth]{images/Data/source3.png}
    }
    \subfloat{%
        \includegraphics[width=0.20\textwidth]{images/Data/source4.png}
    }
